...
Durant le mois de janvier 2026, **20 organisations africaines** ont été victimes de cyberattaques, principalement des ransomwares et des fuites de données, dans le darkweb.
...
- **11 pays** touchés sur le continent
- **20 incidents** recensés au total
...
| 🥉 | **CFM Mozambique** | Ransomware | Infrastructure critique |
...
- **Afrique de l'Ouest** : Sénégal, Togo
...
1. **Renforcez la sécurité** des infrastructures critiques (CFM Mozambique, NWA Kenya)
2. **Auditez les accès** aux bases de données gouvernementales (Togo, Witzenberg)
3. **Mettez en place des cellules de réponse** aux fuites de données
...
| 🔴 **#2** | **Bigbrother / Togo** | Ciblage récurrent depuis septembre 2025 |
| 🔴 **#3** | **Fuites de données** | Tendance émergente (Sénégal, Maroc) |
| 🟡 **#4** | **Secteur financier** | PixPay, CPF, Rogers Capital ciblés |
| 🟡 **#5** | **Afrique de l'Est** | Kenya (4 incidents) |
