...
🇿🇦 Afrique du Sud est le pays le plus représenté avec 30 fiches. Les données restent une mesure de visibilité OSINT : elles ne constituent pas un recensement exhaustif des incidents réels. Cette édition a été entièrement recalculée depuis les fichiers `victims_FR.md` mensuels plutôt qu'incrémentée depuis l'édition précédente (114 fiches). Elle ajoute une revendication nouvellement documentée contre l'Université d'Antananarivo (Madagascar, octobre), et reclasse deux fiches (DAL Group, Soudan ; PPOTTS, Afrique du Sud) de Ransomware vers Fuite de données après avoir constaté un champ explicite `Type d'incident : Fuite de données` présent côté français mais absent côté anglais ; les deux versions linguistiques portent désormais ce champ.
...
| Éducation / Enseignement supérieur | 4 |
| Services financiers & Assurances | 4 |
| Services | 3 |
| Retail (distribution) | 3 |
| Gouvernement / Administration publique | 2 |
| Healthcare services | 2 |
| Financial organizations | 2 |
| Santé / Santé publique | 2 |
...
| Institutions bancaires et financières / Crypto-actifs | 1 |
| Médias, édition et audiovisuel | 1 |
| Gouvernement / Emploi et formation | 1 |
| Industrie manufacturière / Emballages industriels | 1 |
| Technologies de l'information / Téléphonie | 1 |
| Énergie / Pétrole & Gaz | 1 |
| Construction | 1 |
| Business Services | 1 |
...
| Événementiel / Plateforme numérique / Services aux entreprises | 1 |
| Shops | 1 |
...
| Industrie manufacturière / Pneumatiques | 1 |
| Agriculture / Industrie sucrière | 1 |
| Aviation / Organisation intergouvernementale | 1 |
| Ingénierie / Conseil | 1 |
| Gouvernement / Administration fiscale | 1 |
| Distribution / Équipements industriels | 1 |
| Industrie lourde / Matériaux de construction | 1 |
| Services aux entreprises / Facility management | 1 |
| Conseil IT / Intégration logicielle | 1 |
| Services d'assurance | 1 |
| Assurance-vie / Services financiers | 1 |
| Technologies / Services numériques | 1 |
| Agroalimentaire / Boissons | 1 |
| Mobile banking / Services financiers | 1 |
| Grande distribution / Hard-discount | 1 |
| Fintech / Infrastructures de paiement | 1 |
| Administrations publiques / Gouvernement d'État | 1 |
| Distribution d'eau / Service public | 1 |
| Automobile / Véhicules industriels | 1 |
| Audit / Comptabilité / Conseil | 1 |
| Éducation / Recherche Scientifique / Publication Académique | 1 |
| Transport maritime / Agence maritime | 1 |
