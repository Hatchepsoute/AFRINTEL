# AFRINTEL CTI statistics — January 2024

👉🏾 [French version](./README_FR.md)

## Summary

This statistical sheet is compiled from the 12 cards in the monthly victim file. Publications remain claims when the source provides no independent confirmation.
