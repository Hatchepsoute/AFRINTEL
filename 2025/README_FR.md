...
- **Statut:** Revendication & divulgation des données. Le groupe a affirmé avoir exfiltré environ 1,5 To de données sensibles.
- **Description victime:** Intels est un pilier de l'économie nigériane, gérant 90 % des activités de soutien à l'exploration pétrolière offshore.
...
- **Statut:** Revendication & divulgation de 1,2 Go de données
...
- **Statut:** Revendication & divulgation de 400 Go de données
- **Description victime:** INI Investments est une société de portefeuille (holding) égyptienne diversifiée. Elle investit dans des secteurs stratégiques tels que l'immobilier, l'énergie, la technologie et les services financiers.
...
- **Statut:** Fuites des données & divulgation des données
...
- **Site web:** mgptt.dz
- **Statut:** Fuite de données sociales et personnelles. Revendication de type "représailles" avec publication de listes de bénéficiaires.
- **Description victime:** La MGPTT est une institution sociale majeure en Algérie, couvrant les employés du secteur de la Poste, des Télécommunications et de l'Information. Elle gère les remboursements de soins et les aides sociales de dizaines de milliers de fonctionnaires et contractuels.
...
- **Statut:** Fuite de documents administratifs
...
- **Statut:** Revendication & divulgation des données
- **Description victime:** Caisse nationale de sécurité sociale du Kenya. Montant de la rançon demandée : 4,5 millions USD.
- **Note :** Ce piratage (2.5 To de données) a eu des répercussions majeures sur les partenaires régionaux en Afrique australe en mai 2025.
...
- **Groupe/acteur:** NightSpire
- **Secteur:** Gouvernement / Immobilier et Foncier.
- **Site web:** https://www.ancfcc.gov.ma/
- **Statut:** Fuite massive (3,1 Go). Publication de plus de 10 080 certificats de propriété originaux.
- **Description victime:** L'ANCFCC est l'organisme vital chargé de l'immatriculation foncière, du cadastre et de la cartographie au Maroc.
...
- **Acteur malveillant:** RainbowDF
- **Secteur:** Technologies / Distribution Multimédia.
- **Site web:** yasat.tn
- **Statut:** Fuite de données massive. Le dump contient les tables de la base de données de production, confirmant une intrusion directe (probablement via une faille de type injection SQL).
...
### 06 Août 2025
#### 🇲🇦 Maroc - New Era Com
- **Acteur malveillant:** Chucky_BF
- **Secteur:** Télécoms / Infrastructures / Services IT.
- **Site web:** neweracom.ma
- **Statut:** Fuite de données publique (Dump SQL). Publication d'un fichier de 607 Mo contenant plus de 476 000 enregistrements.
- **Description victime:** Société marocaine spécialisée dans l'ingénierie des télécoms, l'installation d'infrastructures réseaux et les solutions ERP/CRM.
...
- **Statut:** Mise en vente & Fuite de données massive. Revendication de l'exfiltration de plus de 1,8 million d'enregistrements incluant des données clients et des fichiers employés.
- **Description victime:** L'une des plus grandes institutions financières du Nigeria et d'Afrique anglophone, cotée à la Bourse du Nigeria et à celle de Londres.
...
- **Acteur malveillant:** Tanaka
- **Secteur:** Assurances / Services Financiers.
- **Site web:** https://www.nsiaassurances.com
- **Statut:** Fuite de données & Mise en vente. Circulation d'une base de données massive incluant plus de 2,5 millions d'enregistrements transactionnels et financiers.
- **Description victime:** Leader de l'assurance et de la banque en Afrique de l'Ouest et Centrale, acteur systémique basé à Abidjan en Côte d'Ivoire.
...
### 04 Novembre 2025
#### 🇲🇦 Maroc - DOVERN Import
- **Groupe ransomware:** spacebears / Space Bears
- **Secteur:** Logistique
- **Site web:** https://dovern-import.com/
- **Statut:** Revendication & Menace de divulgation.
...
- **Statut:** Mise en vente & Fuite de données.
...
- **Note:** L'acteur a mis en circulation une base de données de 12,1 Go contenant les informations de 537 877 utilisateurs.
