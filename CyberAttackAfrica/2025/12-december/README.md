...
# CTI Report: Cyberattacks in Africa - December 2025 (14 victims)
...
## 2. Executive summary
December 2025 shows an increase in ransomware activity with 14 victims identified across 7 African countries. The month is marked by a significant concentration of attacks in Egypt and South Africa, along with persistent targeting of the healthcare sector in North Africa.

* **Total recorded attacks**: 14
* **Most active threat actors**: `lockbit5` (3 attacks), `qilin` (3 attacks).
    * *Other active groups*: dragonforce (2), nova (2), kazu, ransomhouse, devman, direwolf (1 attack each).
* **Most targeted sectors**: Healthcare (3), Finance/Leasing (2), Insurance (2), Public Administration (2).
* **Most affected countries**: 🇪🇬 Egypt (4), 🇿🇦 South Africa (3), 🇹🇳 Tunisia (3).
...
### 4.6 Actor → victim → country mapping
```mermaid
graph LR
...
## 5. Industry analysis
* **Healthcare (3)**: High vulnerability in Tunisia with three major incidents affecting university hospitals and medical associations.
...
* **🇪🇬 Egypt**: Remains the primary target for the second consecutive month with **4 victims** in technology, finance, and industrial sectors.
...
## 9. Conclusion
December 2025 shows a surge in ransomware impact across North and Southern Africa. The diversification of actors (8 groups) and the repeated targeting of healthcare institutions indicate that threat actors are prioritizing high-impact targets where downtime is not an option.
