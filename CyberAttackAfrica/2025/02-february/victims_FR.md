...
Février 2025 compte **8 incidents uniques** : **8 Ransomware**, **0 Data Leak**, **0 Access Sale**, **0 DDoS**, **0 Defacement** et **0 Operational Fraud**, dans **6 pays africains**.
...
- **Site web:** [xlab-group.com](https://xlab-group.com/)
...
- **Site web:** [askgs.ma](https://askgs.ma/)
- **Statut:** Claim - Unverified
- **Type d'incident:** Ransomware
...
- **Site web:** [weathersa.co.za](https://www.weathersa.co.za/)
- **Statut:** Claim - Unverified
- **Type d'incident:** Ransomware
...
- **Site web:** [services.gov.zm](http://services.gov.zm/)
...
- **Site web:** [brolly.africa](https://brolly.africa/)
- **Statut:** Claim - Data Sample Published
- **Type d'incident:** Ransomware
...
- **Site web:** [paratus.africa](https://www.paratus.africa/)
- **Statut:** Claim - Unverified
- **Type d'incident:** Ransomware
...
- **Site web:** [speed-com.eg](https://speed-com.eg/)
- **Statut:** Claim - Unverified
- **Type d'incident:** Ransomware
...
- **Site web:** [shaghalni.com](https://shaghalni.com/)
- **Statut:** Claim - Data Sample Published
- **Type d'incident:** Ransomware
