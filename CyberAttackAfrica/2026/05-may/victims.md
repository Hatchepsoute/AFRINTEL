...
- **Sector :** Government / Labour / Public Administration
...
- **Sector:** Food Processing, Packaging, Household Care & Industrial Chemicals
...
- **Sector :** Retail / Consumer Goods Industry
...
- **Analysis:**  
  This leak exposes highly detailed personally identifiable information (PII), particularly valuable for **targeted phishing campaigns**, **employment fraud**, **identity theft**, and **social engineering** against African professionals. The presence of phone numbers and precise physical addresses also facilitates harassment, telephone scams (*vishing*), and bank fraud. Although the `country` field shows `FR` in the sample, the seller explicitly identifies these records as belonging to citizens or residents of Kenya, Ethiopia, Nigeria, and Zimbabwe, making the threat directly applicable to these countries. The relatively low volume per country (under 500) suggests a targeted collection or a segment of a larger database, but the precision of the data makes it equally dangerous.
---
...
- **Sector:** E-commerce / Grocery Delivery
- **Status:** Data Breach / API Exposure
...
- **Status:** Access Sale / Suspected Compromise  
- **Description:**  
...
- **Sector:** Charity / Zakat (Islamic alms) / Non-profit
- **Status:** Data Leak
...
- **Threat Actor / Group:** Kazu  
- **Sector:** Government / National Statistics / Public Administration  
...
- **Analysis:**  
  One of the most critical PII exposures. Full passport scans enable unlimited identity theft, cross-border fraud, visa application fraud, and financial crime. Victims in Egypt and Libya face severe risks including identity cloning, document forgery, and national security threats.
---
### May 19, 2026
...
- **Analysis:**  
  This offer is extremely critical. Access to over 10,000 official police email accounts provides buyers with:
  - direct access to internal communications and ongoing investigations;
  - the ability to impersonate officers to send fraudulent emails from a legitimate government domain (`@tpf.go.tz`);
...
- **Analysis:**
  ...
  The published records demonstrate the exposure of personal information and provide a credible indication of unauthorized access to data associated with Sheriff Randburg West.
  
#### 🇪🇬 Egypt - Wuzzuf.net [Database Leak / Sale]
- **Actor / Group:** Databasehooligan (forum [Citizen])
- **Sector:** Recruitment / Online Job Platform
...
- **Description:**  
  ...
  Asking price: **$1,100**.
- **Analysis:**  
  Extremely critical leak. Beyond standard PII, the "Authentication Records" section exposes identity documents, verification videos, and risk scores. This enables large-scale identity theft, KYC bypass, deepfake fraud, and sophisticated social engineering. The platform, widely used in Egypt, risks massive legal liability and loss of user trust.
---
### May 26, 2026
