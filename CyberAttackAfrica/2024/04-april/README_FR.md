...
En avril 2024, l'Afrique a enregistré **5 victimes** documentées d'attaques par ransomware dans 5 pays différents. Le mois est marqué par deux cibles de premier plan : une **coentreprise pétrolière libyenne majeure** (~1 To exfiltré) et une **plateforme d'échange de cryptomonnaies** aux Seychelles. Le groupe SpaceBears apparaît pour la première fois avec deux revendications simultanées.

👉🏾 [Liste des victimes](./victims_FR.md)

**Chiffres clés :**
- 🔹 **5 victimes** identifiées
- 🔹 **4 groupes actifs** : InCransom (1), Hunters (1), SpaceBears (2), RansomHub (1)
- 🔹 **Pays touchés** : Afrique du Sud (2), Seychelles (1), Maroc (1), Libye (1)
- 🔹 **Secteurs** : Banque/Crypto, Médias & Édition, Industrie/Emballage, Technologies, Pétrole & Gaz
...
|------|---------|------|-------------------|
| 4 avril | Remitano (Plateforme d'échange crypto) | Seychelles | InCransom |
| 13 avril | Caxton and CTP Publishers and Printers | Afrique du Sud | Hunters |
| 29 avril | SM Emballage | Maroc | SpaceBears |
| 29 avril | Thinkadam | Afrique du Sud | SpaceBears |
| 30 avril | Mellitah Oil & Gas (Eni / NOC JV) | Libye | RansomHub |

```mermaid
timeline
    title Attaques ransomware en Afrique - Avril 2024
...
```mermaid
pie showData
    title Répartition par pays - Avril 2024 (5 victimes)
    "Afrique du Sud" : 2
    "Seychelles" : 1
    "Maroc" : 1
    "Libye" : 1
...
xychart-beta
    ...
    x-axis ["Banque/Crypto", "Médias", "Industrie", "Technologies", "Pétrole & Gaz"]
...
xychart-beta
    ...
    y-axis "Nombre d'attaques" 0 to 10
    bar [3, 5, 7, 5]
```
